...
<title>Catalogo Ad_registro clientes</title>
...
$result_bqd=mysqli_query($connec,"select * from catalogo_clientes where email_aso='$email_aso'");
...
<table width="363" border="0">
  <tr bgcolor="#F8DA94">
<? if ($retorna=="ERROR") {  ?>
    <th scope="col"><div align="center"><a href="catalogo_ingre_clientes.php?id=<?php  echo($idid); ?>">ERROR RETORNAR</a></div></th>
<? } else { ?>
