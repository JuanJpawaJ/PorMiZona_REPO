...
$retornar_ax="a_list_items_admin.php";	
...
if ($xmod=="1") {   // CARACTERISTICAS  11111 admin
    ...
    $sql="UPDATE a_items SET codfabrica_it='$codfabrica',producto_it='$producto',marka_it='$marka',fabricante_it='$fabricante',msjpublico_it='$msjpub' WHERE id=$id";
	...
	$sql="UPDATE a_items SET precom_it='$precom',monelista_it='$monelista' WHERE id=$id";
	...
	$sql="UPDATE a_items SET pv01_it='$pv01',pv02_it='$pv02',pv03_it='$pv03' WHERE id=$id";
	$result2=mysqli_query($connec,$sql);
	if($result2){
	  echo ("<span style='background-color: #006600'>Ok.  ACTUALIZADO 222222  Ok.</span>");
	}else{
	...
	$sql="UPDATE a_items SET grupolista_it='$grupolista' WHERE id=$id";
	$result2=mysqli_query($connec,$sql);
	if($result2){
	  echo ("<span style='background-color: #006600'>Ok.  ACTUALIZADO 222222  Ok.</span>");
	}else{
	...
	$sql="UPDATE a_items SET stockmin_it='$stockmin',lugar_al_it='$lugar_al',view01_it='$view01', view02_it='$view02', view03_it='$view03', view04_it='$view04', time_entrega_it='$time_entrega', img_it='$img',obscompra_it='$obscompra' WHERE id=$id";
	$result2=mysqli_query($connec,$sql);
	if($result2){
	  echo ("<span style='background-color: #006600'>Ok.  ACTUALIZADO 222222  Ok.</span>");
	}else{
...
<table width="363" border="0">
  <tr bgcolor="#F8DA94">
    <th scope="col"><div align="center"><a href="n_admin_3view.php?idx=<?php  echo($id); ?>&xview=<?php  echo("ADMIN"); ?>&xareg=NNOOO&xmodi=NOOOOO&xdelreg=NOOOOO">RETORNAR</a></div>
