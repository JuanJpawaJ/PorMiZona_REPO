...
<table width="1030" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="1030" bgcolor="#00238c"><table width="1000" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="678" align="center" class="TITULO_AMARILLO">COMANDO GENERAL xxxxyyy</td>
  ...
  <tr>
    <td height="386" align="center" valign="middle" bgcolor="#CCCCCC"><table width="951" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="center" valign="top"><table width="350" border="1" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td colspan="5" align="center">CATALOGO CLIENTES</td>
            </tr>
          <tr>
            <td width="70">&nbsp;</td>
            ...
            <td width="55" class="texto_link"><a href="../siga_catalogo/catalogo_list_items_admin.php">CATALOGO<BR />LISTA<BR />ITEMS<BR />ADMIN</a></td>
