...
if      ($form=="TODO00") {
   ...
   echo ("form :").$form;
   echo ("cod :").$cod;
   echo ("latixx :").$latitud_aso;
   echo ("longxx :").$longitud_aso;
...
provincia_aso='$provincia_aso',distrito_aso='$distrito_aso',referencia_aso='$referencia_aso', telf1_aso='$telf1_aso', telf2_aso='$telf2_aso', productos_aso='$productos_aso', datehoy_aso='$datehoy_aso', msjpublico_aso='$msjpublico_aso'   WHERE cod_aso=$cod";
    $result=mysqli_query($connec,$sql);
	if($result){
		echo ("<span style='background-color: #006600'>Ok. ---DATOS REGISTRADOS-- Ok.</span>");
	}else{
