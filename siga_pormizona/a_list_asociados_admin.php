...
?>
     ...
     <? } else {  ?>
			<a href="../siga_catalogo/bienve_clave_pmz.php?xusername=<?php  echo($email_aso); ?>&xpassword=<?php echo($pass_aso); ?>&xrsocial=<?php echo($rsocial_aso); ?>&xtelf1=<?php echo($telf1_aso); ?>&xtelf2=<?php echo($telf2_aso); ?> "><img src="iconos/ico_llave.png" width="25" height="20"></a>
	<?    }?>
		 </td>
