...
<?  } ?>  
  ...
  <tr>
    <td height="39" colspan="2" class="txt_view_direccion"  ><? echo $direccion_aso."<br>"; ?></td>
    <td height="39" colspan="2" class="txt_view_direccion" ><? echo $telf1_aso." / ".$telf2_aso."<br>"; ?></td>
    </tr>
  <tr>
