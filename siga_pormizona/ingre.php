...
if ($email_aso==$xemail AND  $pass_aso==$xclave) { ?>
 ...
 <?  } else { ?>
       <form id="form0" name="form0" method="post" onsubmit="return checkSubmit();" action="/siga_catalogo/catalogo_list_items_admin.php" onkeypress="javascript:if(event.keyCode==13){return false;}" >
         <input type="hidden" name="xcod" value=<? echo $cod_aso; ?> >
