...
<? } else { ?>
    <th scope="col" class="semi-titulosform"><div align="center"><a href="formingre2.php?xcod=<?php  echo($cod_aso); ?>"><?php  echo("xxx cod que viajará XX".$cod_aso); ?>CONTINUAR CON EL PASO 3</a></div></th>
<? } ?>
  </tr>
</table>
